        ...
        <div className="flex flex-col items-center gap-4">
          {player ? (
            <>
              ...
              <Link href="/parent/card" className="btn-secondary w-full text-center text-sm">View Full Card</Link>
            </>
          ) : (
          ...
          <div className="card p-5">
            ...
            {!sessions?.length ? (
              ...
              <div key={s.id} className="flex items-center gap-3 py-3 border-b border-white/5 last:border-0">
                ...
                {i === 0 && <span className="bg-teal-400 text-navy-900 text-[9px] font-black px-2 py-0.5 rounded">NEXT</span>}
              </div>
            ))}
          </div>
